...
guard :concat, :type => "css", :files => %w[vendor/bootstrap/bootstrap vendor/bootstrap/bootstrap-responsive style], :input_dir => "public/css", :output => "public/css/styles.min"

guard :concat, :type => "js", :files => %w[vendor/jquery/jquery-2.0.2 vendor/bootstrap/bootstrap], :input_dir => "public/js", :output => "public/js/scripts.min"
