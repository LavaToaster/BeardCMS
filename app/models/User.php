...
class User extends Eloquent implements Cartalyst\Sentry\Users\UserInterface {
    ...
    public function attemptActivation($activationCode)
    {
        if ($this->activated)
        {
            throw new Cartalyst\Sentry\Users\UserAlreadyActivatedException('Cannot attempt activation on an already activated user.');
        }
     ...
     * @return bool
     */
    public function removeGroup(Cartalyst\Sentry\Groups\GroupInterface $group)
    {
        if ($this->inGroup($group))
        {
     ...
     * @return bool
     */
    public function inGroup(Cartalyst\Sentry\Groups\GroupInterface $group)
    {
     ...
     * @return void
     */
    public static function setHasher(Cartalyst\Sentry\Hashing\HasherInterface $hasher)
    {
