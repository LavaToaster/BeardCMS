...
class Group extends Eloquent implements \Cartalyst\Sentry\Groups\GroupInterface
{
    /**
    ...
    public function validate()
    {
        ...
        if ( ! $name = $this->name)
        {
            throw new Cartalyst\Sentry\Groups\NameRequiredException("A name is required for a group, none given.");
        }
        ...
        {
            throw new Cartalyst\Sentry\Groups\GroupExistsException("A group already exists with name [$name], names must be unique for groups.");
        }
