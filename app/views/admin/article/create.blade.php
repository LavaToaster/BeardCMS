    ...
    <div class="row">
        <div class="col-12">
            <fieldset>
                ...
                @endforeach
                @endif
                {{ Form::open(['method' => 'post', 'route' => ['admin.article.store']]) }}
                <div class="row">
                    <div class="col-lg-8 form-horizontal">
                        <div class="form-group">
                            <label class="col-lg-2 control-label" for="title">Title</label>
                            <div class="col-lg-10">
                                {{ Form::text('title', Input::old('title'), ['id' => 'title', 'class' => 'form-control', 'placeholder' => 'E.G: Home...']) }}
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label" for="page_content">Content</label>
                            <div class="col-lg-10">
                                {{ Form::textarea('article_content', Input::old('content'), ['id' => 'page_content','class' => 'form-control']) }}
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="panel">
                            <div class="panel-heading">
                                <i class="icon-wrench"></i> Article Settings
                            </div>
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-lg-3 control-label" for="slug">Slug</label>
                                    <div class="col-lg-9">
                                        {{ Form::text('slug', Input::old('slug'), ['id' => 'slug', 'class' => 'form-control', 'placeholder' => 'home.html']) }}
                                    </div>
                                </div>
                                <div class="form-group">
